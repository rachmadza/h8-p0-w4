...
/**
 * buat variable tampil dengan nilai 0 untuk menampung berapa kali suatu angka tampil di dalam array
 * buat variable mod untuk menampung angka yang mulai
 * 
 *
*/
...
function cariModus(arr) {
    ...
    for (i = 0; i < arr.length; i++) {
        ...
        } else if (tampil <= 1 || tampil == arr.length) {
